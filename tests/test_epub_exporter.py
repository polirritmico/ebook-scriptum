...
def test_export_epub() -> None:
    ...
    output_path = "tests/files/outputs/exporter-export_epub"
...
def test_update_epub_section() -> None:
    ...
    case_output = Path("tests/files/temp-test_update_epub_section.epub")
    ...
    after_importer.load_data(case_input)
